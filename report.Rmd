...
- there is a linear relationship between `wages` and the explanatory variables, such that \(Y_i \sim \mathcal{N}(\mu_i,\sigma^2)\)
- the residuals are normally distributed with a homogenous variance
