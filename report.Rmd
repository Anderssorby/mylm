...
\begin{equation}
\frac{\nicefrac{SSE}{p-1}}{\nicefrac{SSR}{n-p}} = \frac{\nicefrac{`r sprintf('%.3f', model1$sse)`}{`r length(model1$beta)-1`}}{\nicefrac{`r sprintf('%.3f', model1$sst)`-`r sprintf('%.3f', model1$sse)`}{`r n-length(model1$beta)`}} \sim \chi^2
\end{equation}
**e)**
